...
globalkeys = awful.util.table.join(
    ...
    -- Trash awful.key({ modkey            }, "r",      function () mypromptbox[mouse.screen]:run() end),
    ...
    awful.key({ modkey,           }, "l", function () os.execute("bash ~/.lock.sh") end),
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "z",        function () awful.util.spawn("xkb-switch -n") end),
...
awful.rules.rules = {
    ...
    { rule = { class = "Rambox" },
      properties = { titlebars_enabled = false } },
    { rule = { class = "gnome-terminal-server", "Gnome-terminal" },
      properties = { titlebars_enabled = false } },
